      ...
      leftMenu: [
        { label: 'TRANG CHỦ', url: '/', children: [] },
        {
          ...
          children: [
            ...
            { label: 'Cảm nhận khách hàng', url: '/tin-tuc' },
            { label: 'Báo chí nói về Hoàng Kim', url: '/tin-tuc' },
            { label: 'Các hoạt động của Hoàng Kim', url: '/tin-tuc' },
            { label: 'Tin tuyển dụng', url: '/tin-tuc' },
            { label: 'Thông báo', url: '/tin-tuc' },
          ],
        },
        {
          label: 'DỊCH VỤ',
          url: '/dich-vu',
          children: [
            { label: 'Dịch vụ thiết kế kiến trúc', url: '/dich-vu' },
            { label: 'Dịch vụ thiết kế nội thất', url: '/dich-vu' },
            { label: 'Dịch vụ thiết kế thi công trọn gói', url: '/dich-vu' },
            { label: 'Dịch vụ thi công xây dựng cơ bản', url: '/dich-vu' },
            { label: 'Dịch vụ thi công hoàn thiện nội thất', url: '/dich-vu' },
            { label: 'Sản xuất nội thất cao cấp', url: '/dich-vu' },
            { label: 'Báo giá xây biệt thự trọn gói', url: '/dich-vu' },
          ],
        },
        {
          ...
          children: [
            ...
            { label: 'Biệt thự Phố', url: '/thiet-ke-biet-thu' },
            { label: 'Thiết kế nhà phố', url: '/thiet-ke-biet-thu' },
            { label: 'Thiết kế sân vườn', url: '/thiet-ke-biet-thu' },
            { label: 'Nhà mái Thái', url: '/thiet-ke-biet-thu/biet-thu-mai-thai' },
            { label: 'Nhà mái Nhật', url: '/thiet-ke-biet-thu/biet-thu-mai-nhat' },
            { label: 'Nhà mái Bằng', url: '/thiet-ke-biet-thu' },
          ],
        },
        {
      ...
      rightMenu: [
        {
          ...
          url: '/thi-cong',
          children: [
            { label: 'Hình ảnh hoàn thiện kiến trúc', url: '/thi-cong' },
            { label: 'Dự án kiến trúc đang thi công', url: '/thi-cong' },
            { label: 'Lễ khởi công xây dựng dự án', url: '/thi-cong' },
            { label: 'Video nhà đẹp', url: '/tin-tuc' },
            { label: 'Hình ảnh hoàn thiện nội thất', url: '/thi-cong' },
            { label: 'Dự án nội thất đang thi công', url: '/thi-cong' },
            { label: 'Video cập nhật tiến độ thi công', url: '/tin-tuc' },
          ],
        },
        {
          label: 'DỰ ÁN 3 MIỀN',
          url: '/thi-cong',
          children: [
            { label: 'Miền Bắc', url: '/thi-cong' },
            { label: 'Miền Trung', url: '/thi-cong' },
            { label: 'Miền Nam', url: '/thi-cong' },
          ],
        },
        {
          label: 'VIDEO',
          ...
          children: [
            { label: 'Video nhà đẹp', url: '/tin-tuc' },
            { label: 'Video tiến độ thi công', url: '/tin-tuc' },
            { label: 'Video kỹ thuật thi công', url: '/tin-tuc' },
            { label: 'Cảm nhận của khách hàng', url: '/tin-tuc' },
            { label: 'Báo chí nói về Hoàng Kim', url: '/tin-tuc' },
          ],
        },
        {
          ...
          url: '/tin-tuc',
          children: [
            { label: 'Tư vấn thiết kế', url: '/tin-tuc' },
            { label: 'Kinh nghiệm xây nhà', url: '/tin-tuc' },
            { label: 'Thước lỗ ban', url: '/tin-tuc' },
            { label: 'Tra cứu hướng nhà', url: '/tin-tuc' },
            { label: 'Tra cứu tuổi xây dựng', url: '/tin-tuc' },
            { label: 'Tư vấn phong thuỷ', url: '/tin-tuc' },
            { label: 'Tạp chí nhà đẹp', url: '/tin-tuc' },
            { label: 'Kiến trúc quanh ta', url: '/tin-tuc' },
          ],
        },
