...
router.get('/login', (req, res) => {
  ...
  res.render('admin/login', { layout: 'layouts/admin', title: 'Đăng nhập', error: null });
});
...
router.post('/login', async (req, res) => {
  ...
  if (!user || !(await user.comparePassword(password))) {
    return res.render('admin/login', { layout: 'layouts/admin', title: 'Đăng nhập', error: 'Sai tên đăng nhập hoặc mật khẩu' });
  }
